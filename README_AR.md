...
يستبدل Playwright المدمج في openclaw بـ [Patchright](https://github.com/Kaliiiiiiiiii-Vinyzu/patchright) (نسخة fork غير قابلة للكشف من Playwright)، مما يقلل بشكل كبير من احتمالية اكتشاف المتصفحات الآلية وحجبها من قبل المواقع المستهدفة.
...
يحل محل `web_search` المدمج في openclaw بقدرات بحث أكثر قوة. مقارنةً بالحلول المماثلة في السوق، يتميز البحث الذكي بثلاث مزايا جوهرية:

- **مجاني تماماً، لا يتطلب مفتاح API**: لا يعتمد على أي API بحث من طرف ثالث — تكلفة صفرية
- **بحث فوري لأقصى درجات الحداثة**: يوجّه المتصفح مباشرةً إلى الصفحات المستهدفة أو منصات التواصل الاجتماعي الكبرى (ويبو، Twitter/X، Reddit، إلخ) للحصول فوراً على أحدث المنشورات
