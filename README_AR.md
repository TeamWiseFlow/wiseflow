...
اعتباراً من الآن، يمكنك استخدام نماذج سلسلة OpenAI بخصم 10% من السعر الرسمي داخل تطبيق wiseflow (الخدمة مقدمة من AiHubMix API طرف ثالث).

**ملاحظة:** للاستفادة من الخصم، تحتاج إلى التبديل إلى فرع aihubmix، راجع [README](https://github.com/TeamWiseFlow/wiseflow/blob/aihubmix/README_AR.md) للتفاصيل.
...
- LLM_API_BASE="https://api.siliconflow.com/v1" # عنوان واجهة خدمة LLM (يُنصح باستخدام خدمة siliconflow، مرحباً بك لاستخدام [رابط الإحالة](https://cloud.siliconflow.cn/i/WNLYbBpi) للتقديم، سنحصل كلانا على مكافأة منصة بقيمة ￥14🌹)
