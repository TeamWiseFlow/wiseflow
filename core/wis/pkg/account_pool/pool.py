...
import json
from .field import AccountInfoModel, AccountStatusEnum, AccountWithIpModel
from wis.pkg.proxy import IpInfoModel
from wis.pkg.proxy.proxy_ip_pool import ProxyIpPool
from wis.pkg.tools import utils
from wis.nodriver_helper import CookieExporter


class AccountPoolManager:
    def __init__(self, platform_name: str, work_dir: str):
        """
        ...
        self._cookie_exporter = CookieExporter(platform_name, work_dir)
    ...
    async def async_initialize(self):
        ...
        """
        existing_platform_login_token_file = self._cookie_exporter.cookie_data_dir / "login_token.json"
    ...
    async def get_active_account(self, url: str = None, force_login: bool = False) -> AccountInfoModel:
        """
        get active account
        Returns:
        ...
        cookies, user_agent = await self._cookie_exporter(url, force_login)
...
class AccountWithIpPoolManager(AccountPoolManager):
    def __init__(
        ...
        """
        super().__init__(platform_name, work_dir)
