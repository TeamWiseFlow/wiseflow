...
async def cryptopanic_crawler(url: str, logger) -> (int, dict):
    if not url.startswith('https://cryptopanic.com'):
        logger.warning(f'{url} is not a cryptotracker url, you should not use this function')
        return -5, {}
    ...
    async with httpx.AsyncClient() as client:
        ...
        # await page.setUserAgent('Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/605.1.15 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/604.1 Edg/112.0.100.0')
        # await page.goto('https://www.baidu.com/')
        # # await page.waitForSelector('div.news-cells')
