...
本リポジトリの [Releases](https://github.com/TeamWiseFlow/wiseflow/releases) から openclaw_for_business と wiseflow addon を含む統合パッケージを直接ダウンロードし、解凍後にワンクリックデプロイスクリプトを実行してください。
