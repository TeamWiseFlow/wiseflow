...
**ابتداءً من الإصدار 4.2، يرجى تحميل متصفح Google Chrome أولاً وتثبيته في المسار الافتراضي**
...
- PRIMARY_MODEL=ByteDance-Seed/Seed-OSS-36B-Instruct # للسيناريوهات الحساسة للسعر والاستخراج البسيط، يمكن استخدام Qwen3-14B
...
مرحباً بشراء إصدار WiseFlow Pro (¥488 / سنة)

مقارنة بالإصدار مفتوح المصدر، يوفر إصدار Pro بالإضافة إلى ذلك:

- دعم إضافي لخمس منصات اجتماعية رئيسية: حساب WeChat الرسمي، Douyin، Bilibili، Xiaohongshu، وZhihu
- برنامج تشغيل بنقرة واحدة، لا حاجة للتثبيت أو النشر (يدعم Win10/11، macOS، Ubuntu)
- واجهة مستخدم حديثة لجميع مجموعات العملاء (مترجمة بالكامل)
- دليل تشغيل مفصل (وثائق Feishu)
- واجهة برمجة تطبيقات محلية لتسهيل التكامل مع الأنظمة الأخرى
- بنية أكثر استقراراً وأداءً محسناً
- يشمل الاشتراك رسوم استخدام LLM (لا حاجة لإعدادات إضافية)
- مجموعة WeChat للمستخدمين المدفوعين (ردود سريعة وتبادل مجتمعي)

التفاصيل: https://wiseflow.pro/ 