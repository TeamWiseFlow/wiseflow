...
4.x 版本的 docker 部署方案未经测试，我们欢迎来自社区的开源贡献，PR 一经采纳，我们将赠送 wiseflow-pro 版本一年使用权（含相关 LLM 调用费用）

## 🌹 付费服务

欢迎购买 wiseflow-pro 版本（￥488 / 年）

相较开源版，Pro 版本额外提供：

- 额外支持五大社交平台：微信公众号、抖音、B站、小红书、知乎
- 一键运行程序，无需安装与部署（支持 Win10/11、macOS、Ubuntu）
- 面向全客户群体的现代化UI界面（全汉化）
- 详细操作手册（飞书文档）
- 提供本地 API，方便与其他系统整合
- 更稳定的架构与优化性能
- 订阅已包含 LLM 调用费用（无需额外配置）
- 付费用户微信群（快速反馈与社区交流）

详情：https://shouxiqingbaoguan.com/