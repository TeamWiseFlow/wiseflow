...
Use this skill when:
- A video has been generated by `siliconflow-video-gen` and needs publishing to YouTube
...
Use the `.json` file generated by `siliconflow-video-gen`:
...
- `siliconflow-video-gen` outputs compliant 9:16 videos by default when using appropriate prompts (specify 9:16 ratio)
